...
@bot.command(aliases = ["kill_bot", "murder_bot", "slay_bot", "kill_yourself", "kys"])
...
async def hello(ctx):
    greetings = ["greetings", "salutations", "hello", "hi", "hiya", "howdy", "howdy partner", ":)", "wazzup", "what's up", "hello fellow human being"]
    #print("responding")
